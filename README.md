...
C# Window Form Program to upload files to FTP Server (.net framework 4.5.2)
...
## Screenshot
<img src="https://github.com/ongyishen/WinFormFTPUploadFiles/blob/main/Sample.gif?raw=true" />
